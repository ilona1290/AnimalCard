export let LocaleText = {
    ...
    filterOperatorIs: 'Danego dnia',
    filterOperatorNot: 'Każdego innego dnia poza',
    filterOperatorAfter: 'Po tym dniu',
    filterOperatorOnOrAfter: 'Od tego dnia',
    filterOperatorBefore: 'Przed tym dniem',
    filterOperatorOnOrBefore: 'Tego dnia i wcześniej',
    filterOperatorIsEmpty: 'Bez daty',
