...
function PreviewVisitRabiesVaccination({ rabiesVaccinations }){
    return(
                            ...
                            <TableBody>
                                {rabiesVaccinations.map((row) => (
                                    <StyledTableRow key={row.name}>
                                        ...
                                        <StyledTableCell align="center">{row.termValidityRabies.$d.toLocaleDateString()}</StyledTableCell>
                                        <StyledTableCell align="center">{row.termNextRabies.$d.toLocaleDateString()}</StyledTableCell>
                                    </StyledTableRow>
                                ))}
                            </TableBody>
                        </Table>
...
export default PreviewVisitRabiesVaccination;