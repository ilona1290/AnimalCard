...
function CreateAnimalCard(){
    ...
    return(
        <div style={{width:"100%"}}>
            {isLoading && <Loader />}
            {!isLoading && <div>
            {showPreview === true ? <PreviewPetProfile handleShowPreview={handleShowPreview} pet={pet} owners={owners} formPhoto={formPhoto}/> : <div><div style={{width: "100%", paddingTop: "10em", display: "flex"}}>
            <Link to="/vetMenu">
