...
const rows = [
  ...
  const columns = [
    { field: "DiseaseDate", headerName: "Data diagnozy", type: "date", flex: 1, minWidth: 110, headerAlign: 'center', align: 'center', renderHeader: () => (
        <strong>
          {'Data diagnozy'}
        </strong>
      )},
    { field: "DiseaseDescription", headerName: "Opis choroby", type: "string", flex: 4, minWidth: 350, headerAlign: 'center',align: 'center', renderHeader: () => (
        <strong>
          {'Opis choroby'}
        </strong>
      )},
    { field: "TreatmentDescription", headerName: "Opis leczenia", type: "string", flex: 5,
